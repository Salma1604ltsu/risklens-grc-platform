...
app = FastAPI(title="RiskLens GRC API", version="0.5.0", description="Cybersecurity risk and compliance management API")
...
def health():
    return {"status": "ok", "service": "risklens-api", "version": "0.5.0"}
