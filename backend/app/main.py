...
app = FastAPI(title="RiskLens GRC API", version="0.3.0", description="Cybersecurity risk and compliance management API")
app.include_router(auth_router)
app.include_router(grc_router)

@app.get("/health", tags=["system"])
def health():
    return {"status": "ok", "service": "risklens-api", "version": "0.3.0"}
